...
// where the heights of the two child subtrees of any node cannot differ by more than one
// If at any time they differ by more than one, rebalancing is done to restore this property.

// Named after its inventors, Georgy Adelson-Velsky and Evgenii Landis, the two soviet inventors,
// who first published it in their 1962 paper "An algorithm for the organization of information".

// Why AVL Tree was invented?.
// Most of the BST operations (e.g., search, max, min, insert, delete.. etc) take O(h) time
// where h is the height of the BST
// In the case of skewed binary tree the cost of these operations may become O(n).

// In order to make sure that the upper bound of these operations to remain O(Logn),
// we will have to make sure that the height of the tree remains O(Logn) after every insertion and deletion.

// Thus AVL tree is invented which make sure the height of tree is always O(Logn)
// where n is the number of nodes in the tree.

// Balance factor
// In AVL tree each node maintains extra information called a balance factor
