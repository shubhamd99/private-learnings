...
| Phase | Strategy | Why |
|---|---|---|
| First page load | SSR | Fast first paint, SEO friendly |
| Attach click handlers etc. | Hydration | Make the server HTML actually work |
| Infinite scroll loads | CSR | Just fetch more data, don't re-render the whole page |
